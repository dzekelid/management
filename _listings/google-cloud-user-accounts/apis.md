...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/management/master/_listings/google-cloud-user-accounts/apis.yaml
...
- name: Google Cloud User Accounts API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/management/master/_listings/google-cloud-user-accounts/project-zones-zone-linuxaccountviews-post.md
x-common:
- type: x-code
