...
- name: Azure Resource Manager API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/management/master/_listings/azure-resource-manager/subscriptions-subscriptionid-providers-microsoft-authorization-locks-lockname-delete.md
x-common:
- type: x-website
