...
- name: Azure Resource Manager API Management Locks Get By Scope
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/management/master/_listings/azure-resource-manager/scope-providers-microsoft-authorization-locks-lockname-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/management/master/_listings/azure-resource-manager/scope-providers-microsoft-authorization-locks-lockname-get-postman.md
x-common:
- type: x-website
